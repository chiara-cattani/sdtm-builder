...
| DOMAIN | VARIABLE | LABEL | CORE | DATA_TYPE | DERIVATION |
|--------|----------|-------|------|-----------|--------|
...
export_domain(result$data,   "AE",     "output", formats = "xpt")
export_domain(result$supp,   "SUPPAE", "output", formats = "xpt")
export_domain(result$relrec, "RELREC", "output", formats = "xpt")
```
